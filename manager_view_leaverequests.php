...
// EXEC the procedure
$sql = "EXEC view_leave_requests @user = ?";
      ...
      <tbody>
        <?php foreach ($requests as $request): ?>
          <tr>
            ...
            <td><?php if(isset($request['type'])) echo $request['type'] ?></td>
            <td><a href= "<?php echo 'manager_requests_details.php?applicant='.$request['applicant'].'&start='.$start.'&type=l' ?>">Details</a></td>
          </tr>
        <?php endforeach; ?>
      </tbody>
    </table>
